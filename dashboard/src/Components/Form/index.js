  ...
  return (
    <>
        <C.Container>
            ...
            <C.RadioGroup>
                <C.Input type="radio" id='rIncome' defaultChecked name='group1' onChange={() => setExpanse(!isExpanse)}/>
                <C.Label htmlFor='rIncome'>Entrada</C.Label>
                <C.Input type="radio" id='rExpenses' name='group1' onChange={() => setExpanse(!isExpanse)}/>
